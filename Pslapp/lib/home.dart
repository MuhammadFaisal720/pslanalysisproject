...
import 'package:psl/topteams.dart';
import 'package:psl/topplayers.dart';
import 'package:psl/teamseason.dart';
                    ...
                    child: Column(
                      children: <Widget>[
                           ...
                           elevation: 10.0,
                            child: GestureDetector(
                              onTap: ()=> Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>TopTeamsPrediction())),
                              child: Container(
                                width: MediaQuery.of(context).size.width*0.48,
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(height:10),
                                    Text("Top Winner Team Prediction",
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 17,
                                        fontWeight: FontWeight.bold,
                        ...
                        Card(
                          ...
                          child: GestureDetector(
                            onTap: ()=> Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>TeamSeasonWinner())),
                            child: Container(
                              width: MediaQuery.of(context).size.width*0.48,
                              height: MediaQuery.of(context).size.height*0.23,
                              child: Column(
